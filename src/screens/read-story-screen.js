...
export default class ReadStoryScreen extends Component {
  static navigationOptions = ({ navigation }) => ({
    ...
    tabBarIcon: ({ tintColor }) => (
      <Icon onTouch={() => {}} name="library-books" size={25} color={tintColor}/>
    ),
  ...
  componentDidMount(){
    const ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1 !== r2});
    fetch('https://guarded-fjord-95834.herokuapp.com/api/categories?order=dateUpdate&orderby=desc&type=2',  {
        method: 'get',
        dataType: 'json',
        headers: {
  ...
  _onRefresh = () => {
    ...
    fetch('https://guarded-fjord-95834.herokuapp.com/api/categories?order=dateUpdate&type=2&orderby=desc',  {
        method: 'get',
        dataType: 'json',
        headers: {
          'Accept': 'application/json',
  ...
  handlerEndReached(){
     ...
     const ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1 !== r2});
     fetch('https://guarded-fjord-95834.herokuapp.com/api/categories?order=dateUpdate&orderby=desc&type=2&skip=' + curQty,  {
        method: 'get',
        dataType: 'json',
        headers: {
          'Accept': 'application/json',
