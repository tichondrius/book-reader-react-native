...
export default class HomeScreen extends Component {
  static navigationOptions = ({ navigation }) => ({
    ...
    tabBarIcon: ({ tintColor }) => (
      <Icon onTouch={() => {}} name="apps" size={25} color={tintColor}/>
    ),
  ...
  componentDidMount(){
    SplashScreen.hide();
    const ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1._id !== r2._id});
    fetch('https://guarded-fjord-95834.herokuapp.com/api/categories?order=dateUpdate&orderby=desc',  {
        method: 'get',
        dataType: 'json',
        headers: {
  ...
  handlerEndReached(){
     ...
     const ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1._id !== r2._id});
     fetch('https://guarded-fjord-95834.herokuapp.com/api/categories?order=dateUpdate&orderby=desc&skip=' + curQty,  {
        method: 'get',
        dataType: 'json',
        headers: {
          'Accept': 'application/json',
